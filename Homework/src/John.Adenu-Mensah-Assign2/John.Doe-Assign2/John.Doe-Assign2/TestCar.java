...
public class TestCar {
  ...
  public static void main(String[] args) {
    ...
    Person bob = new Person("Bob", 17, "male");
    Person esi = new Person("Esi", 18, "female");
    Person kofi = new Person("Kofi", 21, "male");
    ...
    for (int i = 0; i < 5; i++) {
      pName = "Passenger" + i;
      if (mazda.addPassenger(
          new Person(pName, r.nextInt(40), r.nextBoolean() ? "male" : "female")))
