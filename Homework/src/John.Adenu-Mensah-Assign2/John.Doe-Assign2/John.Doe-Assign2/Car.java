...
public class Car {
    ...
    public static final int MIN_DRIVING_AGE = 18;
    ...
    * If there's a driver, print the driver's name and age; otherwise, print "No driver." 
    * If there are passengers, print the passengers' names and ages;
    */
